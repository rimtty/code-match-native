...
11. QR待機中はCode 128が照合画面へ反映されず、QR読取後のCode 128待機中はQRが反映されないことを確認する。
12. Code 128待機中にアプリを強制終了して再起動し、スキャナが安全状態を経由してQR待機へ戻ることを確認する。
13. 照合完了またはセッション終了後、スキャナのQR／Code 128制限が解除されることを確認する。
